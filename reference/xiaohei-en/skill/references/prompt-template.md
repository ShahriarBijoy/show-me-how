...
Generate each image separately. Replace the variables from the article content; don't combine several images into one.
...
Structure type:
{Workflow / System part / Before-After / Character states / Concept metaphor / Layered method / Map route / Mini comic}

Core idea:
{the core meaning this image expresses}

Composition:
{concrete scene: where Xiaohei is, what it is doing, main objects, how information flows}
